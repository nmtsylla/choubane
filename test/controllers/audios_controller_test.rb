...
class AudiosControllerTest < ActionController::TestCase
  ...
  test "should create audio" do
    assert_difference('Audio.count') do
      post :create, audio: { author: @audio.author, date: @audio.date, image: @audio.image, piste: @audio.piste, string: @audio.string, user_id: @audio.user_id }
    end
  ...
  test "should update audio" do
    patch :update, id: @audio, audio: { author: @audio.author, date: @audio.date, image: @audio.image, piste: @audio.piste, string: @audio.string, user_id: @audio.user_id }
    assert_redirected_to audio_path(assigns(:audio))
  end
